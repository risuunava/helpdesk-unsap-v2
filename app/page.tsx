  ...
  return (
    <motion.div
      initial={
        reduce
          ? false
          : { opacity: 0, y: 12, filter: blur ? "blur(8px)" : "blur(0px)" }
      }
...
function InfiniteMarquee() {
  ...
  return (
    <div className="py-6 border-t border-border/40 bg-background overflow-hidden flex items-center relative z-20 lg:-mt-12">
      ...
      >
        {[...items, ...items].map((item, i) => (
          <div
            key={i}
            className="flex items-center gap-3 text-muted-foreground/40 hover:text-foreground/80 transition-colors duration-300"
          >
  ...
  return (
    <div className="w-full h-44 bg-muted/20 border border-border/30 rounded-xl relative overflow-hidden flex items-center justify-center p-4 sm:p-6">
      ...
      <div className="flex flex-col items-center gap-1.5 z-10">
        ...
        <span className="text-[8px] sm:text-[10px] font-mono text-muted-foreground uppercase tracking-tight truncate max-w-[50px] sm:max-w-none">
          Mahasiswa
        </span>
      </div>
      ...
      <div className="flex flex-col items-center gap-1.5 z-10">
        ...
        <span className="text-[8px] sm:text-[10px] font-mono text-muted-foreground uppercase tracking-tight truncate max-w-[55px] sm:max-w-none">
          Fakultas / Biro
        </span>
      </div>
    </div>
        ...
        {steps.map((step, idx) => (
          <div key={idx} className="flex items-center gap-3">
            <div className="relative flex items-center justify-center">
              ...
              {idx < steps.length - 1 && (
                <div
                  className={`absolute top-4 w-[1px] h-3 ${step.completed ? "bg-foreground" : "bg-border/60"}`}
                />
              )}
            </div>
            <span
              className={`text-xs ${step.active ? "font-medium text-foreground" : "text-muted-foreground"}`}
            >
              {step.label}
            </span>
          </div>
...
const KB_ARTICLES = [
  {
    filter: "Akademik",
    title: "Cara Pengisian KRS Online Mahasiswa Baru",
    time: "Dibaca 1.2k kali",
  },
  {
    filter: "Akademik",
    title: "Panduan Ajukan Cuti Kuliah via Portal Akademik",
    time: "Dibaca 800 kali",
  },
  {
    filter: "Wi-Fi",
    title: "Menghubungkan ke Jaringan Wi-Fi UNSAP-Secure",
    time: "Dibaca 2.1k kali",
  },
  {
    filter: "Wi-Fi",
    title: "Lupa Password Akun Wi-Fi Kampus",
    time: "Dibaca 1.4k kali",
  },
  {
    filter: "Sarana",
    title: "Prosedur Peminjaman Ruang Kelas & Aula Fakultas",
    time: "Dibaca 500 kali",
  },
  {
    filter: "Sarana",
    title: "Laporan Kerusakan Fasilitas Kelas & Gedung",
    time: "Dibaca 950 kali",
  },
];
...
function ParallaxHero() {
  return (
    <section className="relative min-h-[70vh] sm:min-h-[76vh] lg:min-h-[66vh] flex flex-col justify-stretch overflow-hidden border-b border-border/40 bg-background">
      ...
      <div className="max-w-[1400px] w-full mx-auto px-6 flex-1 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-stretch relative z-10 pt-4 lg:pt-12 pb-0">
        <div className="relative z-10 lg:col-span-6 flex flex-col justify-start pt-0 lg:pt-8 pb-16 lg:pb-16">
          <StaggerReveal>
          ...
          <StaggerReveal delay={0.16} blur>
            <p className="text-base md:text-lg text-muted-foreground max-w-[52ch] leading-relaxed mb-8">
              Layanan bantuan akademik, IT, dan infrastruktur Universitas
              Sebelas April dengan pelacakan status real-time.
            </p>
          </StaggerReveal>
          ...
          <StaggerReveal delay={0.24}>
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
              <MagneticWrap strength={0.25} className="w-full sm:w-auto">
                <Link
                  href="/register"
                  className="h-12 px-6 w-full sm:w-auto justify-center bg-foreground text-background hover:bg-foreground/90 rounded-xl font-medium text-sm flex items-center gap-2 active:scale-[0.98] transition-all shadow-sm"
                >
              ...
              <MagneticWrap strength={0.12} className="w-full sm:w-auto">
                <Link
                  href="/login"
                  className="h-12 px-6 w-full sm:w-auto justify-center bg-transparent border border-border hover:bg-muted/50 text-foreground rounded-xl font-medium text-sm flex items-center transition-all"
                >
                  Masuk Portal
                </Link>
              </MagneticWrap>
        ...
        <div className="absolute inset-0 lg:relative lg:inset-auto lg:col-span-6 flex items-end justify-center lg:justify-end z-0 lg:z-10 pointer-events-none lg:pointer-events-auto">
          <StaggerReveal
            delay={0.32}
            className="w-full flex justify-center lg:justify-end items-end h-full"
          >
            <img
              src="/assets/mockup-hero.png"
              alt="UNSAP Helpdesk Mockup Phone"
              className="w-auto h-[72vh] sm:h-[82vh] lg:h-[95vh] object-contain object-bottom block select-none pointer-events-none translate-y-[1px] lg:-translate-y-8 blur-sm lg:blur-none opacity-25 lg:opacity-100 transition-all duration-500"
            />
          </StaggerReveal>
          {/* Masking overlay ONLY for the mockup column */}
          <div className="absolute bottom-0 left-0 right-0 h-56 pointer-events-none z-20">
            ...
            <div className="absolute bottom-24 left-0 right-0 h-32 bg-gradient-to-t from-background to-transparent" />
          </div>
        </div>
      </div>
      <InfiniteMarquee />
            ...
            >
              ...
              <div className="flex gap-3 items-center">
                ...
                <span className="text-foreground">
                  08:20 - Tiket ditugaskan ke Staff IT
                </span>
              </div>
            </motion.div>
          )}
...
function InteractiveWorkflow() {
  ...
  return (
    <section
      id="workflow"
      className="py-24 border-b border-border/40 bg-background text-foreground"
    >
        ...
        <div className="lg:col-span-6 flex flex-col justify-center">
          ...
          <StaggerReveal delay={0.08} blur>
            <p className="text-base text-muted-foreground mb-12 max-w-[50ch] leading-relaxed">
              Tinggalkan koordinasi manual. UNSAP Helpdesk memusatkan laporan
              akademik, IT, dan fasilitas dalam satu alur teratur.
            </p>
          </StaggerReveal>
  ...
  return (
    <div className="min-h-screen bg-background text-foreground selection:bg-foreground/10 selection:text-foreground font-sans">
      ...
      <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/80 backdrop-blur-md">
        <nav className="max-w-[1400px] mx-auto h-16 px-6 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            <Link
              href="/login"
              className="h-10 px-4 hover:bg-muted/50 rounded-xl text-[13px] font-medium flex items-center transition-all"
            >
              Masuk Portal
            </Link>
            <Link
              href="/register"
              className="h-10 px-4 bg-foreground text-background hover:bg-foreground/90 rounded-xl text-[13px] font-medium flex items-center transition-all shadow-sm"
            >
              Buat Laporan
            </Link>
          </div>
      ...
      <main>
              ...
              <div className="lg:col-span-4 flex flex-col justify-between h-full">
                <div>
                  <h3 className="text-lg font-medium text-foreground">
                    Kejelasan status di setiap langkah.
                  </h3>
                  <p className="text-sm text-muted-foreground mt-3 leading-relaxed max-w-[36ch]">
                    Kami merancang sistem ini untuk menghapus birokrasi berbelit
                    dan memberikan resolusi terpantau.
                  </p>
                </div>
              </div>
        ...
        <section
          id="features"
          className="py-24 border-b border-border/40 bg-background"
        >
          <div className="max-w-[1400px] mx-auto px-6">
            <StaggerReveal blur>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <StaggerReveal
                delay={0.05}
                className="md:col-span-2 border border-border/40 bg-card rounded-2xl p-6 flex flex-col justify-between gap-6 overflow-hidden"
              >
                <div className="space-y-2">
                  <div className="w-10 h-10 rounded-xl bg-muted border border-border/40 flex items-center justify-center text-foreground">
                    <Icons.send size={18} />
                  </div>
                  <h3 className="text-base font-semibold pt-1">
                    Routing Otomatis
                  </h3>
                  <p className="text-xs text-muted-foreground leading-relaxed max-w-[48ch]">
                    Tiket laporan secara pintar langsung diarahkan ke tim teknis
                    fakultas atau biro yang bertanggung jawab tanpa antrean
                    manual.
                  </p>
                </div>
                <BentoRoutingWidget />
              ...
              <StaggerReveal
                delay={0.1}
                className="md:col-span-1 border border-border/40 bg-card rounded-2xl p-6 flex flex-col justify-between gap-6"
              >
                <div className="space-y-2">
                  <div className="w-10 h-10 rounded-xl bg-muted border border-border/40 flex items-center justify-center text-foreground">
                  ...
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    Setiap pembaruan status, penugasan staf, hingga komentar
                    dapat dipantau langsung oleh pelapor.
                  </p>
                </div>
                <BentoStatusWidget />
              </StaggerReveal>
              ...
              >
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground leading-relaxed">
                    Sistem mendeteksi isu kritis seperti pemadaman Wi-Fi kampus
                    atau kendala ujian untuk eskalasi prioritas.
                  </p>
                </div>
                ...
                <div className="w-full bg-muted/20 border border-border/30 rounded-xl p-4 space-y-3">
                  ...
                  <div className="flex justify-between items-center text-xs">
                    <span className="px-2 py-0.5 rounded-full bg-red-500/10 text-red-600 dark:text-red-400 border border-red-500/20 font-mono text-[10px] font-medium">
                      Kritikal
                    </span>
                  ...
                  <div className="flex justify-between items-center text-xs">
                    <span className="px-2 py-0.5 rounded-full bg-amber-500/10 text-amber-600 dark:text-amber-400 border border-amber-500/20 font-mono text-[10px] font-medium">
                      Tinggi
                    </span>
                    <span className="text-foreground font-mono text-[11px]">
                      &lt; 2 jam
                  ...
                  <div className="flex justify-between items-center text-xs">
                    <span className="px-2 py-0.5 rounded-full bg-green-500/10 text-green-600 dark:text-green-400 border border-green-500/20 font-mono text-[10px] font-medium">
                      Normal
                    </span>
                    <span className="text-foreground font-mono text-[11px]">
                      &lt; 24 jam
              ...
              <StaggerReveal
                delay={0.2}
                className="md:col-span-2 border border-border/40 bg-card rounded-2xl p-6 flex flex-col justify-between gap-6"
              >
                <div className="space-y-2">
                  <div className="w-10 h-10 rounded-xl bg-muted border border-border/40 flex items-center justify-center text-foreground">
                    <Icons.page size={18} />
                  ...
                  <p className="text-xs text-muted-foreground leading-relaxed max-w-[48ch]">
                    Resolusi dari laporan yang sudah selesai diarsipkan menjadi
                    basis panduan mandiri agar sivitas akademik dapat
      ...
      <footer className="pt-20 pb-12 bg-background border-t border-border/40 text-foreground">
        <div className="max-w-[1400px] mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
            <div className="lg:col-span-2 space-y-4">
              ...
              <p className="text-xs text-muted-foreground max-w-[36ch] leading-relaxed">
                Platform resolusi masalah terpadu untuk Sivitas Akademika
                Universitas Sebelas April.
              </p>
            </div>

            <div className="flex flex-col gap-3.5">
              <h4 className="font-mono text-[10px] uppercase tracking-widest text-muted-foreground mb-1">
                Navigasi
              </h4>
              <Link
                href="/login"
                className="text-xs hover:text-foreground text-muted-foreground transition-colors w-fit"
              >
                Masuk Portal
              </Link>
              <Link
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center pt-8 border-t border-border/40 text-[10px] text-muted-foreground font-mono">
            <p>
              &copy; {new Date().getFullYear()} Universitas Sebelas April. Hak
              Cipta Dilindungi.
            </p>
